...
\hypertarget{class_planner_a233641a9be15517565338788ba5e8bfc}{\index{\-Planner@{\-Planner}!interpolate@{interpolate}}
\index{interpolate@{interpolate}!Planner@{\-Planner}}
\subsubsection[{interpolate}]{\setlength{\rightskip}{0pt plus 5cm}void {\bf \-Planner\-::interpolate} (
\begin{DoxyParamCaption}
\item[{const \-Search\-State\-::\-Ptr \&}]{from\-\_\-state, }
\item[{const \-Search\-State\-::\-Ptr \&}]{to\-\_\-state, }
\item[{vector$<$ \-Graph\-State\-::\-Ptr $>$ \&}]{plan}
\end{DoxyParamCaption}
)}}\label{class_planner_a233641a9be15517565338788ba5e8bfc}


gets the intermediate states between two states with only using diagonal, horizontal, or vertical steps 


\begin{DoxyParams}{\-Parameters}
{\em from\-\_\-state} & \-Search\-State$\ast$ to the state we are starting from \\
\hline
{\em to\-\_\-state} & \-Search\-State$\ast$ to the state we want to stop before \\
\hline
{\em plan} & the vector of graph states for the final plan \\
\hline
\end{DoxyParams}
